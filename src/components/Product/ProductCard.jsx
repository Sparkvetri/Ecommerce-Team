    ...
    >
      ...
      <div className="relative aspect-square bg-[#F5F5F5] rounded-md flex items-center justify-center p-4 sm:p-6 md:p-8 overflow-hidden">
        ...
        <div className="absolute top-2 sm:top-3 right-2 sm:right-3 flex flex-col gap-1.5 sm:gap-2 z-10 opacity-0 sm:group-hover:opacity-100 transition-opacity duration-300">
          <button className="bg-white p-1.5 sm:p-2 rounded-full hover:bg-[#DB4444] hover:text-white transition-all shadow-sm active:scale-95 sm:active:scale-100">
        ...
        <button className="absolute bottom-0 w-full bg-black text-white py-2 sm:py-2.5 translate-y-full sm:group-hover:translate-y-0 transition-transform duration-300 font-medium text-xs sm:text-sm active:bg-gray-800">
          Add To Cart
        </button>
      </div>
