...
export default function BestSellingProducts() {
  ...
  return (
    <section className="w-full py-12 md:py-24 px-4 sm:px-6 lg:px-10 max-w-7xl mx-auto">
      {/* Heading Row */}
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-8">
        <div className="flex flex-col gap-4">
          ...
          <h2 className="text-3xl md:text-4xl font-bold tracking-tight text-gray-900 font-serif">Best Selling Products</h2>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <motion.button 
            ...
            className="hidden md:block bg-red-600 text-white px-10 py-3.5 rounded-full font-bold hover:bg-red-700 transition-all shadow-lg shadow-red-100 text-sm tracking-wide"
          >
            View All
          </motion.button>
        </div>
      ...
      >
        {products.map((product) => (
          <div key={product.id} className="min-w-[75%] sm:min-w-[45%] md:min-w-[31%] lg:min-w-[calc(25%-18px)] snap-start">
